  ...
  component: () => (
    <main className="mx-auto max-w-3xl px-4 py-16 lg:px-8">
      ...
      <div className="mt-6 space-y-4 text-sm text-muted-foreground">
        <p>
          StudyHub Nepal resources are provided free of charge for personal study. You may download
          and print them for your own learning.
        </p>
        <p>Re-selling our material, or republishing it as your own, is not permitted.</p>
        <p>
          We work hard to keep content accurate and syllabus-aligned, but always cross-check with
          your official textbook before exams.
        </p>
      </div>
    </main>
  ),
