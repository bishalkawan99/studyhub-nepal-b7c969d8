...
import { BackToTop, ScrollProgress } from "@/components/SiteChrome";
  ...
  head: () => ({
    meta: [
      ...
      { title: "StudyHub Nepal — Class 11 & 12 Notes, MCQs & Past Papers" },
      {
        name: "description",
        content:
          "Free NEB Class 11 and Class 12 notes, exercise solutions, MCQ practice, model questions and past papers for Nepali students.",
      },
      { name: "author", content: "StudyHub Nepal" },
