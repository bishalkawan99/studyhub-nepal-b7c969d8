//#region node_modules/.nitro/vite/services/ssr/assets/study-data-BfOlECnh.js
var chapterSets = {
	nepali: [
		"गद्य खण्ड – परिचय",
		"कविता खण्ड",
...
var subjects = [
	{
		...
		name: "Nepali",
		icon: "📖",
		blurb: "गद्य, कविता, व्याकरण र निबन्ध"
	},
	{
		slug: "english",
		name: "English",
		icon: "✍️",
		blurb: "Stories, poems and writing skills"
	},
	{
		slug: "mathematics",
	...
	},
	{
		...
		name: "Physics",
		icon: "🧲",
		blurb: "Mechanics, heat, optics and more"
	},
	{
		slug: "chemistry",
		name: "Chemistry",
		icon: "⚗️",
		blurb: "Physical, organic and inorganic"
	},
	{
		slug: "biology",
		name: "Biology",
		icon: "🧬",
		blurb: "Botany, zoology and genetics"
	},
	{
		slug: "computer",
		name: "Computer Science",
		icon: "💻",
		blurb: "Programming, DBMS and web"
	},
	{
		slug: "accountancy",
		name: "Accountancy",
		icon: "🧾",
		blurb: "Company and cost accounting"
	},
	{
		slug: "economics",
		name: "Economics",
		icon: "📈",
		blurb: "Micro, macro and Nepalese economy"
	},
	{
		slug: "business",
		name: "Business Studies",
		icon: "🏢",
		blurb: "Management and marketing"
	}
].map((s) => ({
	...s,
	chapters: chapterSets[s.slug]
}));
var classes = ["11", "12"];
function getSubject(slug) {
	return subjects.find((s) => s.slug === slug);
}
function buildResources(kind) {
	return classes.flatMap((classId) => subjects.map((s) => ({
...
var searchIndex = classes.flatMap((classId) => subjects.flatMap((s) => [{
...
//#endregion
export { leaderboard as a, subjects as c, getSubject as i, buildResources as n, mcqBank as o, classes as r, searchIndex as s, blogPosts as t };
